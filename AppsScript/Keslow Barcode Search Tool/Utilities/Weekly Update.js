function weeklyUpdate() {
  ...
  refreshAnalyticsWeekly();
  
  // Execute Lost & Found barcode check
  checkLostAndFoundAgainstDictionary();
  
  Logger.log("Weekly Update process completed");
}

function refreshAnalyticsWeekly() {
  Logger.log("Starting analytics refresh");
