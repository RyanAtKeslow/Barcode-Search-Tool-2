/**
 * Sort Generic Bay - Barcode Sorting Script
 * 
 * This script sorts barcodes in a bay by their assigned bin numbers,
...
function sortGenericBay() {
  ...
  if (usernameMatches.length > 1) {
    ...
    continueSortGenericBay(selectedMatch.cellA1);
  } else if (usernameMatches.length === 1) {
    continueSortGenericBay(usernameMatches[0].cellA1);
  } else {
...
function continueSortGenericBay(selectedCellA1) {
  var ss = SpreadsheetApp.getActiveSpreadsheet();
  var activeSheet = ss.getActiveSheet();
